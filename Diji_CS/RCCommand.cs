...
namespace Diji_CS
{
    class RCCommand : IPrimitiveCommandEvents
    {
        ...
        public void DataPoint(ref Point3d Point, View View)
        {
            ...
            //column_longitudinal_rebars = RCUtil.create_column_longitudinal_rebars(800, 800, 1500, 400);
            column_longitudinal_rebars = LongitudinalBarUtil.create_column_longitudinal_rebars(800, 800, 1500, 1500, 1500, 400, 50, "1");
            column_stirrups = StirrupUtil.create_column_stirrups(800, 800, 1500, 400, "1");
            ...
            RCUtil.add_part_to_element(ref column_longitudinal_rebars, tfpart_ref);
            RCUtil.add_part_to_element(ref column_stirrups, tfpart_ref);
            RCUtil.add_part_to_element(ref foundation_rebars, tfpart_ref);
            ...
            RCUtil.draw_Elements(elements.ToArray(), "diji");
        }
